...
Examples:
  ...
  Module id = Acme::MetaSyntactic
      ...
      INST_FILE    @@HOMEBREW_PREFIX@@/lib/perl/5.10.0/Acme/MetaSyntactic.pm
      INST_VERSION 0.99
  cpan> a BOOK
  Author id = BOOK
      EMAIL        [...]
...
C<expect>.
  ...
  match:
    ...
    perl: "@@HOMEBREW_PREFIX@@/cariba-perl/bin/perl"
    perlconfig:
      archname: "freebsd"
      not_cc: "gcc"
    env:
...
command such as
    ...
    @@HOMEBREW_PREFIX@@/bin/lynx -pscott:tiger

then you would configure CPAN.pm with the command

    o conf lynx "@@HOMEBREW_PREFIX@@/bin/lynx -pscott:tiger"
...
with the Configure option prefix, e.g.
    ...
    ./Configure -Dprefix=@@HOMEBREW_PREFIX@@/perl-5.6.78.9
