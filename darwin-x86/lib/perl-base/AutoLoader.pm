...
sub import {
    ...
    # '@@HOMEBREW_PREFIX@@/lib/perl5/POSIX.pm', and the autosplit index file is in
    # '@@HOMEBREW_PREFIX@@/lib/perl5/auto/POSIX/autosplit.ix', so we require that.
    #
    # However, if @INC is a relative path, this might not work.  If,
...
F<@@HOMEBREW_PREFIX@@/lib/perl5/POSIX.pm>, B<AutoLoader> will look for perl
subroutines B<POSIX> in F<@@HOMEBREW_PREFIX@@/lib/perl5/auto/POSIX/*.al>, where
